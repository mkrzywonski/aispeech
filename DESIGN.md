...
| `play_sound` | `sound?: string`, `file?: string` | `{ ok, played }` | Play a notification sound: a built-in (`success`, `error`, `ding`), a custom sound by name, or a WAV file path. Respects volume/mute. |
